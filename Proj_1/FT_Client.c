...
int main(int argc, char *argv[])
{
   ...
   int result;
   char ch[] = "explore-events-summer-cricket.jpg", TempStr[100];
   //char ch[] = "index.jpeg", TempStr[100];
   ...
   while(CurrSeg < TotalSeg)
   {
    ...
    printf("\n-----------------------------Start Buffer-----------------------------\n");
    for(TempInt2 = 0; TempInt2 < len; TempInt2++)
      printf("%c",Buffer[TempInt2]);
    printf("\n-----------------------------End Buffer-----------------------------\n");
